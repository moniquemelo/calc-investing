        ...
        <div className="mt-6">
          ...
          {activeTab === 'averagePrice' && (
            <div>
                      ...
                      {rows.map((row, index) => (
                        <div key={index} className="flex items-center gap-4 mb-2">
                          <div className="flex flex-col w-3/12">
                            <label className="block text-md font-medium">Quantidade</label>
                            <input
                              type="number"
                              value={row.quantity}
                          ...
                          <div className="flex flex-col w-1/3">
                            <label className="block text-md font-medium">Cotação</label>
                            <input
                              type="number"
                              value={row.price}
                          ...
                          <div className="flex flex-col w-1/3">
                            <p className="mt-4 text-gray-700 block text- font-medium">
              ...
              <div className="flex flex-col gap-4 text-justify text-zinc-900 font-medium md:text-lg mt-10">
                <p>O <strong>preço médio</strong> nos investimentos é o valor médio ponderado das ações ou ativos adquiridos ao longo do tempo, levando em consideração a quantidade comprada e o preço pago em cada operação. Por exemplo, se você comprou 10 cotas de uma determinada ação a R$ 10,00 e, mais tarde, comprou outras 20 cotas a R$ 12,00, o seu preço médio será calculado levando em conta tanto o valor das compras quanto as quantidades adquiridas.</p>
                <p>O cálculo seria feito da seguinte forma:</p>
                <p>Preço Médio =  10 * R$ 10,00 + 20 * R$ 12,00, logo 100 + 240 = 340, então divide os 340 pelo total de cotas que é 30, resultando em 11,33 de preço médio. Você pode testar na calculadora acima esse exemplo.</p> 
                <p>O monitoramento contínuo do preço médio permite que o investidor tome decisões mais estratégicas. Se o preço atual do ativo estiver muito abaixo do seu preço médio, pode ser uma oportunidade para fazer uma "média de preço para baixo", ou seja, comprar mais ações para reduzir o seu preço médio atual, tornando seu ativo mais barato e proporcionando mais lucro com uma possível valorização. Por outro lado, se o preço atual estiver bem acima, você pode decidir vender ou ajustar a sua estratégia.</p>   
              </div>
            </div>
          )}
        </div> 
